    ...
    "$graph": [
        {
            "requirements": [
                {
                    "dockerPull": "bdgenomics/rhapsody:1.12.1",
        ...
        },
        {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "id": "#AnnotateReads.cwl/num_bioproducts"
                },
                {
                    "type": "int",
                    "outputBinding": {
                    ...
                    "id": "#AnnotateReads.cwl/num_cell_estimate"
                },
                {
                    "type": "int",
                    "outputBinding": {
        ...
        },
        {
            ...
            "expression": "${\n  // the create final bam flag defaults to true\n  var generateBam = true;\n  // the user can set this flag to disable creation of the final bam file.\n  if (inputs._Generate_Bam != null) {\n    generateBam = inputs._Generate_Bam;\n  }\n  return ({\n    Generate_Bam: generateBam,\n  });\n}",
            "id": "#BamSettings.cwl"
        },
        {
            "class": "ExpressionTool",
        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "doc": "By default, a Bam file that is comprised of reads from all the input libraries is generated. However, this can consume a lot of compute and disk resources. By setting this field to false, the Bam is no longer created.\n",
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "out": [
                        ...
                        "#main/AnnotateReads/num_cell_estimate",
                        "#main/AnnotateReads/num_bioproducts"
                    ],
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/AnnotateReads/num_bioproducts",
                            "id": "#main/GetDataTable/num_bioproducts"
                        },
                        {
                            "source": "#main/AnnotateReads/num_cell_estimate",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/MinChunkSize",
                            "id": "#main/Internal_Settings/_MinChunkSize"
                        },
                        {
                            "source": "#main/NumRecordsPerSplit",
                            "id": "#main/Internal_Settings/_NumRecordsPerSplit"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "id": "#main/Internal_Settings/_Subsample_Sample_Tags"
                        },
                        {
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "valueFrom": "BCR",
                            "id": "#main/VDJ_Analyze_Reads_IG/vdj_type"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "valueFrom": "TCR",
                            "id": "#main/VDJ_Analyze_Reads_TCR/vdj_type"
                        }
                    ],
                    "out": [
            ...
            "steps": [
                {
                    ...
                    "run": {
                        "id": "#SplitAndSubsample.cwl/FlattenOutput/run/flatten_output",
                        "cwlVersion": "v1.2",
                        "class": "ExpressionTool",
                        "inputs": [
                            {
                                ...
                                "id": "#SplitAndSubsample.cwl/FlattenOutput/run/flatten_output/nestledSplitFastqList"
                            }
                        ],
                        "outputs": [
                            {
                                ...
                                "id": "#SplitAndSubsample.cwl/FlattenOutput/run/flatten_output/SplitFastqList"
                            }
                        ],
                ...
                },
                {
                    ...
                    "run": {
                        "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq",
                        "class": "CommandLineTool",
                        "cwlVersion": "v1.2",
                        "requirements": [
                            {
                        ...
                        "inputs": [
                            {
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/Fastq"
                            },
                            {
                                "type": {
                                    "type": "array",
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/FilesToSkipSplitAndSubsample"
                            },
                            {
                                "type": [
                                    "null",
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/NumRecordsPerSplit"
                            },
                            {
                                "type": "float",
                                "inputBinding": {
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/SubsampleRatio"
                            },
                            {
                                "type": "int",
                                "inputBinding": {
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/SubsampleSeed"
                            }
                        ],
                        "outputs": [
                            {
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/SplitAndSubsampledFastqs"
                            },
                            {
                                "type": "File",
                                "outputBinding": {
                                ...
                                "id": "#SplitAndSubsample.cwl/SplitAndSubsample/run/split_fastq/log"
                            }
                        ]
                    },
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#VDJ_Analyze_Reads_IG.cwl/VDJ_Version",
                            "id": "#VDJ_Analyze_Reads_IG.cwl/VDJ_Preprocess_Reads_IG/VDJ_Version"
                        },
                        {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#VDJ_Analyze_Reads_TCR.cwl/VDJ_Version",
                            "id": "#VDJ_Analyze_Reads_TCR.cwl/VDJ_Preprocess_Reads_TCR/VDJ_Version"
                        },
                        {
